...
"""
Notificador vía Telegram usando la Bot API.

Lee la configuración de TelegramConfig, que a su vez
toma token, chat_id y timeout desde monitor_settings.yaml.
"""

import requests

from core.interfaces import BaseNotifier        # si está en otra carpeta, ajusta este import
